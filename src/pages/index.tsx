  ...
  return (
    <>
      <Head>
        ...
        <meta name="description" content="Æfingaplan sem hjálpar þér að ná betri árangri! Allar æfingar og myndbönd aðgengilegar í smáforriti og beint samband við þjálfara." />
      </Head>
